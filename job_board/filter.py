...
class JobFilter(django_filters.FilterSet):
    employment_type = django_filters.CharFilter(
        field_name="employment_type", lookup_expr="iexact"
    )
...
class ProfileFilter(django_filters.FilterSet):
    ...
    experience = django_filters.CharFilter(
        field_name="experience", lookup_expr="icontains"
    )
...
class NotificationFilter(django_filters.FilterSet):
    receiver = django_filters.UUIDFilter(
        field_name="receiver__user_id", lookup_expr="exact"
    )
