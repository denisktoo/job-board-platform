...
job_router.register(
    r"applications", JobApplicationViewSets, basename="job-applications"
)
...
company_job_apps.register(
    r"applications", CompanyJobApplicationsViewSet, basename="company-job-applications"
)

user_router = NestedDefaultRouter(router, r"users", lookup="user")
user_router.register(
    r"applications", UserApplicationsViewSet, basename="user-applications"
)
