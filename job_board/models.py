...
class User(AbstractUser):
    ...
    role = models.CharField(
        max_length=10, choices=ROLE_CHOICES, null=False, db_index=True
    )
...
class Company(models.Model):
    ...
    user = models.ForeignKey(
        "User", on_delete=models.CASCADE, db_index=True, related_name="companies"
    )
...
class Job(models.Model):
    ...
    company = models.ForeignKey(
        "Company", on_delete=models.CASCADE, db_index=True, related_name="jobs"
    )
    ...
    employment_type = models.CharField(
        max_length=30, choices=EMPLOYMENT_CHOICES, null=False, db_index=True
    )
...
class Application(models.Model):
    ...
    user = models.ForeignKey(
        "User", on_delete=models.CASCADE, db_index=True, related_name="applications"
    )
    job = models.ForeignKey(
        "Job", on_delete=models.CASCADE, db_index=True, related_name="applications"
    )
...
class CompanyReview(models.Model):
    ...
    company = models.ForeignKey(
        "Company", on_delete=models.CASCADE, related_name="reviews", db_index=True
    )
    user = models.ForeignKey(
        "User", on_delete=models.CASCADE, related_name="company_reviews", db_index=True
    )
...
class Conversation(models.Model):
    ...
    participants = models.ManyToManyField(
        "User", related_name="conversations", db_index=True
    )
    created_at = models.DateTimeField(auto_now_add=True, db_index=True)
...
class Notification(models.Model):
    ...
    def __str__(self):
        ...
        return f"Notification for {receiver} " f"at {self.created_at}"


class MessageHistory(models.Model):
    message_history_id = models.AutoField(primary_key=True)
    message = models.ForeignKey(
        "Message", on_delete=models.CASCADE, related_name="edit_history", db_index=True
    )
